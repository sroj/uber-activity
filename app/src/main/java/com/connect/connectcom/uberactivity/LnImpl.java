...
public class LnImpl
    ...
    public LnImpl(Application context) {
        try {
            ...
            Ln.d(
                "Configuring Logging, minimum log level is %s",
    ...
    public int v(
        ...
        if (getLoggingLevel() > Log.VERBOSE) { return 0; }

        final String s = s1.toString();
        final String message = formatArgs(
            s,
            args
        );
        return println(
    ...
    public int d(
        ...
        if (getLoggingLevel() > Log.DEBUG) { return 0; }
    ...
    public int i(Throwable t) {
        return getLoggingLevel() <= Log.INFO
               ? println(
            Log.INFO,
            Log.getStackTraceString(t)
        )
    ...
    public int i(
        ...
        if (getLoggingLevel() > Log.INFO) { return 0; }
    ...
    public int w(Throwable t) {
        return getLoggingLevel() <= Log.WARN
               ? println(
            Log.WARN,
            Log.getStackTraceString(t)
        )
    ...
    public int w(
        ...
        if (getLoggingLevel() > Log.WARN) { return 0; }
    ...
    public int e(Throwable t) {
        return getLoggingLevel() <= Log.ERROR
               ? println(
            Log.ERROR,
            Log.getStackTraceString(t)
        )
    ...
    public int e(
        ...
        if (getLoggingLevel() > Log.ERROR) { return 0; }
